...
public class WebServiceServiceLocator extends org.apache.axis.client.Service implements webservice.WebServiceService {
    ...
    private java.lang.String WebService_address = "http://localhost:8080/JPA_BI_WS/services/WebService";
    ...
    public webservice.WebService getWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webservice.WebServiceSoapBindingStub _stub = new webservice.WebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webservice.WebService.class.isAssignableFrom(serviceEndpointInterface)) {
                webservice.WebServiceSoapBindingStub _stub = new webservice.WebServiceSoapBindingStub(new java.net.URL(WebService_address), this);
                _stub.setPortName(getWebServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice", "WebServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice", "WebService"));
        }
